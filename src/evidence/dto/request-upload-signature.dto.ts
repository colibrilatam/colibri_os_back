...
export class RequestUploadSignatureDto {
  @ApiProperty({
    description: 'UUID de la evidencia previamente creada para la que se solicita la firma',
  ...
  @ApiProperty({
    description: 'Tipo de evidencia — determina la carpeta destino en Cloudinary',
    enum: EvidenceType,
