...
export class CreateNftActorDto {
  ...
  @ApiProperty({
    description: 'Dirección del contrato',
  ...
  @ApiProperty({
    description:
      'Hash del NFT huella única que identifica al NFT en el sistema de Colibrí, opcional',
    example: 'QmXoYpZ...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'URI de los metadatos del NFT',
