...
export class SubmitAiResultDto {
  @ApiProperty({
    description: 'UUID de la evaluación a la que se adjunta el resultado de IA',
    example: 'eval-uuid-0001',
  })
  @IsUUID()
  evaluationId: string;
  ...
  @ApiProperty({
    description: 'Veredicto emitido por la IA',
  ...
  @ApiPropertyOptional({
    description: 'Puntaje global asignado por la IA (0-100)',
    example: 82,
    minimum: 0,
    maximum: 100,
  })
  ...
  @ApiPropertyOptional({
    description: 'Nivel de confianza del modelo en su veredicto (0-1)',
    example: 0.91,
    minimum: 0,
    maximum: 1,
  })
  ...
  @ApiPropertyOptional({
    description: 'Razonamiento textual del modelo',
    example: 'La evidencia cumple con todos los criterios de la rúbrica.',
  })
  @IsOptional()
  @IsString()
  aiReasoning?: string;
  ...
  @ApiPropertyOptional({
    description: 'Respuesta completa del modelo en crudo (para auditoría)',
