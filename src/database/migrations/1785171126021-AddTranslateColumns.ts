...
export class AddTranslateColumns1785171126021 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "rubrics" SET "name_es" = "name", "description_es" = "description"`);
        await queryRunner.query(`UPDATE "micro_action_definitions" SET "instruction_es" = "instruction"`);
        await queryRunner.query(`UPDATE "pacs" SET "title_es" = "title", "objective_line_es" = "objective_line"`);
        await queryRunner.query(`UPDATE "categories" SET "name_es" = "name", "description_es" = "description"`);
        await queryRunner.query(`UPDATE "tramos" SET "name_es" = "name", "description_es" = "description", "eligibility_rule_es" = "eligibility_rule"`);
        ...
        await queryRunner.query(`ALTER TABLE "micro_action_definitions" ALTER COLUMN "instruction_es" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "rubrics" SET "name" = "name_es", "description" = "description_es"`);
        await queryRunner.query(`UPDATE "micro_action_definitions" SET "instruction" = "instruction_es"`);
        await queryRunner.query(`UPDATE "pacs" SET "title" = "title_es", "objective_line" = "objective_line_es"`);
        await queryRunner.query(`UPDATE "categories" SET "name" = "name_es", "description" = "description_es"`);
        await queryRunner.query(`UPDATE "tramos" SET "name" = "name_es", "description" = "description_es", "eligibility_rule" = "eligibility_rule_es"`);

        // Set NOT NULL on columns that were originally NOT NULL
        await queryRunner.query(`ALTER TABLE "rubrics" ALTER COLUMN "name" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "micro_action_definitions" ALTER COLUMN "instruction" SET NOT NULL`);
